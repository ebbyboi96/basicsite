...
window.templates['item'] = function anonymous(locals, escapeFn, include, rethrow
) {
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("\">\n        </div>\n        <div class=\"post-info-container\">\n            <a href=\"/posts/1\" class=\"post-title\">")
    ; __line = 7
    ; __append(escapeFn( description ))
